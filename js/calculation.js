...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var clickButton = document.getElementById("equals-button");
  clickButton.addEventListener('click', function() {

    if (isNaN(document.getElementById("value-1").value) == true || isNaN(document.getElementById("value-2").value) == true 
        || document.getElementById("value-1").value == '' || document.getElementById("value-2").value == '') {
      ...
      if (operation == '+') {
        var equals = parseInt(document.getElementById("value-1").value) + parseInt(document.getElementById("value-2").value);
      } else if (operation == '-') {
        var equals = parseInt(document.getElementById("value-1").value) - parseInt(document.getElementById("value-2").value);
      } else if (operation == 'x') {
      var equals = parseInt(document.getElementById("value-1").value) * parseInt(document.getElementById("value-2").value);
